        ...
        <div className="fixed right-0 bottom-0 left-0 bg-black/70 p-4">
          {title && (
            <div className="flex items-center gap-3">
              ...
              <a
                href={`https://github.com/verekia/r3f-gamedev/blob/main/pages${router.pathname}.tsx`}
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 rounded bg-white/10 px-2 py-1 text-xs text-white/80 hover:bg-white/20"
              >
